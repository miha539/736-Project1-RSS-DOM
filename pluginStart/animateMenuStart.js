        ...
        var methods = {
            ...
            init : function(options) {
                ...
                return this.each(function() {
                    // change the colors of the rows
					$('li:even', $(this) ).css('background-color',settings.evenColor);
					$('li:odd', $(this) ).css('background-color',settings.oddColor);
					
					//attach mouseover and mouseout for animation!
					
					$('li',$(this)).on('mouseover,'function(){
						$(this).animate({paddingLeft:settings.animatePadding},300);
					}).on('mouseout',function(){
						$(this).animate({paddingLeft:settings.defaultPadding},300);
